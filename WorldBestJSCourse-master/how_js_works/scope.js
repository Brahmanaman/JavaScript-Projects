...
//? When code runs inside a function, JavaScript first looks for the variable inside that function’s own scope.If it doesn’t find it there, it goes to the parent scope (where the function was created, not called).It keeps moving up through parent scopes — all the way to the global scope.If it’s not in the global scope, you get a ReferenceError.
